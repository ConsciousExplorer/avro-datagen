...
def _schema_to_tmp(schema_dict):
    ...
    tmp = tempfile.NamedTemporaryFile(suffix=".avsc", delete=False, mode="w")
...
with tab_editor:
    ...
    with col_save:
        ...
        if st.button("Save to file", use_container_width=True, type="primary", disabled=not can_save):
